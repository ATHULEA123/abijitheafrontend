  ...
  return (
    <div className='relative h-screen flex items-center justify-center overflow-hidden'>
      ...
      <div className='relative z-10 text-center text-white'>
        ...
        <h2 className='text-5xl md:text-7xl font-light animate-slide-up'>ABIJITH EA</h2>

        {/* Subtitle with fade-in animation */}
        <p className='text-sm md:text-lg mt-4 animate-fade-in'>Exploring the Space Between Thought and Form</p>
        ...
        <div className='flex items-center justify-center'>
          <button className='mt-6 py-2 px-4 border border-white rounded-full text-white flex items-center justify-center transition-colors animate-fade-in'>
            <a href="/Collections" className='flex flex-row'>Works<img src={rightarrowwhite} alt="Right arrow" className='w-6 ml-2' /></a>
          </button>
        </div>
      </div>
    </div>
