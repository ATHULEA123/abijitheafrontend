    ...
    <div className='contact'>
      <div className='flex flex-col lg:flex-row items-center justify-center mt-24 px-6 lg:px-12'>
        ...
        <div className='flex-1 flex justify-center items-center w-full lg:w-1/2 lg:mr-8'>
          <form className='w-full max-w-lg bg-gray-800 p-6 rounded-lg shadow-md' onSubmit={onSubmit}>
        ...
        <div className='flex-1 flex w-full flex-col items-flex-start lg:w-1/2 text-center lg:text-left text-white mt-12 lg:mt-0'>
          <div>
            ...
            <p className='text-lg mb-2'>
              Number: <a href="tel:+917034349362" target="_blank" rel="noopener noreferrer" className='text-white underline font-mono font-semibold text-sm hover:bg-blue-500'>+917034349362</a>
            </p>
            <p className='text-lg mb-2'>
              Email: <a href="mailto:eaabijith3@gmail.com" target="_blank" rel="noopener noreferrer" className='text-white underline font-mono font-semibold text-sm hover:bg-blue-500'>eaabijith3@gmail.com</a>
            </p>
