...
const Aboutadmin = ({isDarkMode}) => {
  ...
  return (
    <div className="px-4 md:px-8 lg:px-16">
      <h1 className="{`${isDarkMode ? 'text-black':'text-white'}  my-10 text-center text-4xl font-bold">ABIJITH E A</h1>
      ...
      <div className="flex flex-col items-center justify-center mt-10">
        <div className="flex flex-col md:flex-row items-center gap-4">
          <button className="mt-6 py-2 px-4 border ${isDarkMode ? 'border-black':'border-white'}e rounded-full ${isDarkMode ? 'text-black':'text-white'} flex items-center justify-center hover:text-black transition-colors">
            <a
          ...
          <button className="mt-6 py-2 px-4 border ${isDarkMode ? 'border-black':'border-white'}  rounded-full ${isDarkMode ? 'text-black':'text-white'} flex items-center justify-center bg-white hover:text-black transition-colors">
            <a
        ...
        <div className="flex items-center justify-center gap-4 mt-8">
          ...
          <button
            className="py-2 px-4 bg-green-500 ${isDarkMode ? 'text-black':'text-white'} rounded-full"
      ...
      {showDeletePopup && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <h2 className="text-lg font-semibold mb-4 text-black">Are you sure you want to delete the artist data?</h2>
